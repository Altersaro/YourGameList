...
function Sidebar() {
    ...
    const {genres, showAlert, refreshPage} = React.useContext(ClientApiContext);
    ...
    function logOut(){
        ...
        axios.post('http://localhost:8000/api/auth/logout',{headers:{
                    ...
                    <ul className="dropdown-menu dropdown-menu-dark shadow user-menu ">
                        
                        {
                            ...
                            <>
                                ...
                                <li><a className="dropdown-item dropdown-link"  onClick={logOut}>Sign out</a></li>
                            </>
                            :
                            <>
